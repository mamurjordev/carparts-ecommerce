                            ...
                            <table class="cart-table__table">
                                <thead class="cart-table__head">
                                    <tr class="cart-table__row">
                                        <th
                                            class="cart-table__column cart-table__column--image"
                                        >
                                            Image
                                        </th>
                                        <th
                                ...
                                <tbody class="cart-table__body">
                                    <tr class="cart-table__row">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <img
                                                        class="image__tag"
                                                        src="images/products/product-4-160x160.jpg"
                                                        alt=""
                                                    />
                                                </a>
                                            </div>
                                        ...
                                        >
                                            <div
                                                class="cart-table__quantity input-number"
                                            >
                                                <input
                                    ...
                                    <tr class="cart-table__row">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <img
                                                        class="image__tag"
                                                        src="images/products/product-5-160x160.jpg"
                                                        alt=""
                                                    />
                                                </a>
                                            </div>
                                        ...
                                        >
                                            <a
                                                href=""
                                                class="cart-table__product-name"
                                                >Twin Exhaust Pipe From Brandix
                                                Z54</a
                                            >
                                            <ul class="cart-table__options">
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            <div class="cart-table__actions">
                                                <form
                                                    class="cart-table__coupon-form form-row"
                                                >
                                                    <div
                                                        class="form-group mb-0 col flex-grow-1"
                                                    >
                                                        <input
                                                            type="text"
                                                    ...
                                                    <div
                                                        class="form-group mb-0 col-auto"
                                                    >
                                                        <button
                                                            type="button"
                                                ...
                                                <div
                                                    class="cart-table__update-button"
                                                >
                                                    <a
                                                        class="btn btn-sm btn-primary"
                                                        href=""
