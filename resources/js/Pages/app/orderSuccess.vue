    ...
    <app-layout>
        ...
        C45.2,71.4,44.6,71.4,44.2,71z"
                                ...
                                <table>
                                    <thead class="order-list__header">
                                        <tr>
                                            ...
                                            <th
                                                class="order-list__column-total"
                                            >
                                                Total
                                            </th>
                                        </tr>
                                    ...
                                    <tbody class="order-list__products">
                                        <tr>
                                            <td
                                                class="order-list__column-image"
                                            >
                                                <div
                                            ...
                                            <td
                                                class="order-list__column-product"
                                            >
                                                <a href="product-full.html"
                                                    >Brandix Spark Plug Kit
                                                    ASR-400</a
                                                >
                                                <div
                                                ...
                                                >
                                                    <ul
                                                        class="order-list__options-list"
                                                    >
                                                        <li
                        ...
                        <div class="order-success__addresses">
                            <div
                                class="order-success__address card address-card"
                            >
                                <div
                                    class="address-card__badge tag-badge tag-badge--theme"
                                >
                                    Shipping Address
                                </div>
