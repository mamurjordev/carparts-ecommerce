 ...
 c0,2.8,2.2,5,5,5c2.8,0,5-2.2,5-5C13,5.2,10.8,3,8,3z"
                ...
                >
                    <div class="suggestions__group">
                        <div
                            v-if="progress.search"
                            class="suggestions__group-title text-center"
                        >
                        ...
                        <div v-else class="">
                            <div
                                v-if="
                                    !searches.parts.length &&
                                        !searches.oems.length &&
                                        !searches.vins.length
                                "
                                class="text-center"
                            >
                            ...
                            <div class="suggestions__group-content">
                                <inertia-link
                                    v-for="(search, index) in searches.parts"
                                    :key="index"
                                    ...
                                    <div class="suggestions__product-info">
                                        <div class="suggestions__product-name">
                                            ...
                                            <span class="text-sm text-gray-700"
                                                >({{ search.oemNumber }})</span
                                            >
                                        </div>
                                    </div>
                                </inertia-link>
                                <inertia-link
                                    v-for="(search, index) in searches.vins"
                                    :key="index + 600"
                                    class="suggestions__item suggestions__product"
                                    :href="'/categories/' + search.carId"
                                >
                                    <div class="suggestions__product-info">
                                        <div class="suggestions__product-name">
                                            {{ search.manuName }}
                ...
                >
                                ...
                                <div class="vehicles-list__body">
                                    <label class="vehicles-list__item">
                                        ...
                                        <span class="vehicles-list__item-info">
                                            ...
                                            >
                                            <span
                                                class="vehicles-list__item-details"
                                                >Engine 2.0L 1742DA L4 FI
                                                Turbo</span
                                            >
                                        </span>
                                        <button
                    ...
                    >
                        <div class="vehicle-picker__panel-body">
                            <div
                                class="vehicle-form vehicle-form--layout--search"
                            >
                                <div
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <option
                                            >Diesel 2.5L 200 hp AT/L5</option
                                        >
                                        <option
                                            >Diesel 3.0L 250 hp MT/L5</option
                                        >
                                    </select>
                                </div>
