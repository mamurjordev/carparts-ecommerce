...
l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                            ...
                                            <div class="product-card__image">
                                                <div class="image image--type--product">
                                                    <a href="/single-product" class="image__body">
                                                        <img class="image__tag" src="images/tire.jpg" alt="">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="product-card__info">
                                                ...
                                                <div class="product-card__name">
                                                    <div>
                                                        ...
                                                        <a href="/single-product">Brandix Spark Plug Kit ASR-400</a>
                                                    </div>
                                                </div>
...
l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                            ...
                                            <div class="product-card__image">
                                                <div class="image image--type--product">
                                                    <a href="/single-product" class="image__body">
                                                        <img class="image__tag" src="images/body.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                    <div class="status-badge__body">
                                            ...
                                            <div class="product-card__info">
                                                ...
                                                <div class="product-card__name">
                                                    <div>
                                                        <a href="/single-product">Brandix Brake Kit BDX-750Z370-S</a>
                                                    </div>
                                                </div>
                                                <div class="product-card__rating">
                                                    <div class="rating product-card__rating-stars">
...
l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                            ...
                                            <div class="product-card__image">
                                                <div class="image image--type--product">
                                                    <a href="/single-product" class="image__body">
                                                        <img class="image__tag" src="images/dumper.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                    <div class="status-badge__body">
                                            ...
                                            <div class="product-card__info">
                                                ...
                                                <div class="product-card__name">
                                                    <div>
                                                        <a href="/single-product">Twin Exhaust Pipe From Brandix Z54</a>
                                                    </div>
                                                </div>
                                                <div class="product-card__rating">
                                                    <div class="rating product-card__rating-stars">
...
l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                            ...
                                            <div class="product-card__image">
                                                <div class="image image--type--product">
                                                    <a href="/single-product" class="image__body">
                                                        <img class="image__tag" src="images/fuel.png" alt="">
                                                    </a>
                                                </div>
                                                <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                    <div class="status-badge__body">
                                            ...
                                            <div class="product-card__info">
                                                ...
                                                <div class="product-card__name">
                                                    <div>
                                                        <a href="/single-product">Motor Oil Level 5</a>
                                                    </div>
                                                </div>
                                                <div class="product-card__rating">
                                                    <div class="rating product-card__rating-stars">
...
l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                            ...
                                            <div class="product-card__image">
                                                <div class="image image--type--product">
                                                    <a href="/single-product" class="image__body">
                                                        <img class="image__tag" src="images/sus.png" alt="">
                                                    </a>
                                                </div>
                                                <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                    <div class="status-badge__body">
                                            ...
                                            <div class="product-card__info">
                                                ...
                                                <div class="product-card__name">
                                                    <div>
                                                        <a href="/single-product">Brandix Engine Block Z4</a>
                                                    </div>
                                                </div>
                                                <div class="product-card__rating">
                                                    <div class="rating product-card__rating-stars">
...
l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z" />
                                            ...
                                            <div class="product-card__image">
                                                <div class="image image--type--product">
                                                    <a href="/single-product" class="image__body">
                                                        <img class="image__tag" src="images/repare-kits.png" alt="">
                                                    </a>
                                                </div>
                                                <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                    <div class="status-badge__body">
                                            ...
                                            <div class="product-card__info">
                                                ...
                                                <div class="product-card__name">
                                                    <div>
                                                        <a href="/single-product">Brandix Clutch Discs Z175</a>
                                                    </div>
                                                </div>
                                                <div class="product-card__rating">
                                                    <div class="rating product-card__rating-stars">
